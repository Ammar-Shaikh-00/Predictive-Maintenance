...
const TEXT_DE = {
  ...
  "needs downtime event history — not invented.":
    "Erfordert Stillstands-Ereignishistorie.",
  "not model accuracy — readiness from connected sources.":
    "Bereitschaft aus verbundenen Datenquellen.",
  "shown only after validated model outcomes and cost baseline — never invented.":
    "Noch nicht verfügbar. Erscheint erst, wenn validierte Modellergebnisse und eine Kostenbasislinie vorliegen.",
};
