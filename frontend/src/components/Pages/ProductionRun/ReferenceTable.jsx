        ...
        <table className="w-full min-w-[680px] text-sm">
          ...
          <tbody>
            {rows.map(({ parameter, current, reference, deviation, status }) => (
              <tr key={parameter} className="border-b border-white/5 last:border-0">
                <td className="py-3 font-medium text-slate-200">{parameter}</td>
                <td className="py-3 text-slate-300">{current}</td>
                <td className="py-3 text-slate-300">{reference}</td>
                <td className="py-3 text-slate-300">{deviation}</td>
                <td className="py-3">
